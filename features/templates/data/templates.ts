...
export const TEMPLATES: Template[] = [
  // ─── お礼 ───
  {
    ...
    label: "親しみやすく",
    body:
      "{姓}さん、昨日はありがとうございました🌸 {前回の話題}のお話、本当に楽しかった。また近いうちにお顔見せてくださいね😊",
  ...
  },
  {
    ...
    label: "もう一歩距離を縮めたい",
    body:
      "{姓}さん、昨日はお会いできて嬉しかったです💕 {前回の話題}の続き、また聞かせてくださいね。寂しくなっちゃうのでお待ちしてます🌙",
  ...
  // ─── お誘い ───
  {
    ...
    label: "やんわり再来店",
    body:
      "{姓}さん、お元気ですか？✨ {ボトル名}もまだ残ってるので、お時間できたらお顔見せてくださいね。",
  ...
  },
  {
    ...
    label: "話題つきで誘う",
    body:
      "{姓}さん、お久しぶりです🌸 {前回の話題}のその後、気になってました。今度お話聞かせてくださいね😊",
  ...
  // ─── お祝い ───
  {
    ...
    label: "誕生日当日",
    body:
      "{姓}さん、お誕生日おめでとうございます🌸 {姓}さんにとって素敵な1年になりますように✨ お祝い、お店で待ってますね💕",
    description: "当日朝の送信に",
  },
  {
    id: "birthday-ahead",
    ...
    label: "前祝いで誘う",
    body:
      "{姓}さん、もうすぐお誕生日ですね✨ お店でお祝いさせてください。{ボトル名}も準備してお待ちしてます🥂",
  ...
  // ─── 季節 ───
  {
    ...
    label: "気遣いベース",
    body:
      "{姓}さん、季節の変わり目ですが体調崩されてませんか？☕ またお時間あるときにお店で一息つきにいらしてくださいね🌙",
  ...
  },
  {
    ...
    label: "イベント・行事",
    body:
      "{姓}さん、いつもありがとうございます🌸 季節の素敵な時間、お店で一緒に過ごせたら嬉しいです✨ お待ちしてますね。",
